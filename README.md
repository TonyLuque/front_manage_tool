...
La pantalla de inicio se encuentra divida en tres secciones. siendo de izquierda a derecha, busqueda del dispositivo por su serial, busqueda del usuario por email y asiganación del dispositvo a traves de su serial y el id del usuario.
